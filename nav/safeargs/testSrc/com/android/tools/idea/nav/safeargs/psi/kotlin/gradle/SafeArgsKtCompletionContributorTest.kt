...
class SafeArgsKtCompletionContributorTest {
  ...
  fun testBasicCompletion() {
    ...
    val argsElements = fixture.lookupElements.orEmpty()
      .map {
    ...
    fixture.completeBasic()
    val directionsElements = fixture.lookupElements.orEmpty()
      .map {
        val presentation = LookupElementPresentation()
        it.renderElement(presentation)
        presentation
    ...
    fixture.completeBasic()
    val allElements = fixture.lookupElements.orEmpty()
      .map {
        val presentation = LookupElementPresentation()
        it.renderElement(presentation)
        presentation
  ...
  fun testCompletionInImports() {
    ...
    fixture.completeBasic()
    fixture.lookupElements.orEmpty()
      .map {
        val presentation = LookupElementPresentation()
        it.renderElement(presentation)
        presentation
